...
<body>
	...
	<form action="updateFreeForm" method="post" enctype="multipart/form-data" onsubmit="return formCheck();">
	...
	<h1>FREE BOARD</h1>
		...
		<br>
		ATTACHEMENT<br><c:if test="${originalFile == null}">
